             ...
             <ul class="side-menu">
                 ...
                 <li class="slide {{$title == 'Menu' || $title == 'Role' || $title == 'User' || $title == 'Akses' || $title == 'Web' ? 'is-expanded' : ''}}">
                     <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">
                         ...
                         <span class="side-menu__label">Ajustes</span><i class="angle fe fe-chevron-right"></i></a>
                     <ul class="slide-menu">
                         @if($getSettingMenu > 0)
                         ...
                         <li class="sub-slide {{$title == 'Role' || $title == 'User' || $title == 'Akses' ? 'is-expanded' : ''}}">
                             <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="javascript:void(0)"><span class="sub-side-menu__label">Usuário</span><i class="sub-angle fe fe-chevron-right"></i></a>
                             <ul class="sub-slide-menu">
                                 @if($getSettingRole > 0)
                                 <li><a class="sub-slide-item {{$title == 'Role' ? 'active' : ''}}" href="{{url('/admin/role')}}">Função</a></li>
                                 @endif
                                 @if($getSettingUser > 0)
                                 <li><a class="sub-slide-item {{$title == 'User' ? 'active' : ''}}" href="{{url('/admin/user')}}">Lista</a></li>
                                 @endif
                                 @if($getSettingAkses > 0)
                                 <li><a class="sub-slide-item {{$title == 'Akses' ? 'active' : ''}}" href="{{url('/admin/akses/role')}}">Acesso</a></li>
                                 @endif
                             </ul>
                         </li>
                         @if($getSettingWeb > 0)
                         <li><a href="{{url('/admin/web')}}" class="slide-item {{$title == 'Web' ? 'active' : ''}}">Página</a></li>
                         @endif
                     </ul>
                 </li>
                 @endif
                 ...
                 <li class="slide">
                     <a class="side-menu__item" data-bs-effect="effect-super-scaled" data-bs-toggle="modal" href="#modalLogout"><i class="side-menu__icon fe fe-log-out"></i><span class="side-menu__label">Sair</span></a>
                 </li>
