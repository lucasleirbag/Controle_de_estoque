...
<div class="page-header">
    <h1 class="page-title">Gráfico</h1>
    <div>
        <ol class="breadcrumb">
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="text-white">
                        ...
                        <p class="text-white mb-0">Tipos</p>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="text-white">
                        ...
                        <p class="text-white mb-0">Marca do Produto</p>
                    </div>
                    <div class="ms-auto"> <i class="fe fe-package text-white fs-40 me-2 mt-2"></i> </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="text-white">
                        ...
                        <p class="text-white mb-0">Produto</p>
                    </div>
                    <div class="ms-auto"> <i class="fe fe-package text-white fs-40 me-2 mt-2"></i> </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="text-white">
                        ...
                        <p class="text-white mb-0">Entrada de Produtos</p>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="text-white">
                        ...
                        <p class="text-white mb-0">Saida de Produtos</p>
                    </div>
                    <div class="ms-auto"> <i class="fe fe-repeat text-white fs-40 me-2 mt-2"></i> </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="text-white">
                        ...
                        <p class="text-white mb-0">Locais</p>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="text-white">
                        ...
                        <p class="text-white mb-0">Usuários</p>
                    </div>
                    <div class="ms-auto"> <i class="fe fe-user text-white fs-40 me-2 mt-2"></i> </div>
                </div>
            </div>
