...
class UserController extends Controller
{
    ...
    public function update(Request $request, UserModel $user)
    {
        ...
        $data['title'] = "User";
        Session::flash('status', 'success');
        Session::flash('msg', 'Alterado com sucesso!');
    ...
    public function updatePassword(Request $request, UserModel $user)
    {
        ...
        if ($checkPassword > 0) {
            ...
            Session::flash('status', 'success');
            Session::flash('msg', 'Password Sucesso di ubah!');
        } else {
    ...
    public function updateProfile(Request $request, UserModel $user)
    {
        ...
        $data['title'] = "Profile";
        Session::flash('status', 'success');
        Session::flash('msg', 'Profile Alterado com sucesso!');
    ...
    public function hapus(Request $request)
    {
        ...
        $data['title'] = "User";
        Session::flash('status', 'success');
        Session::flash('msg', 'Excluído com sucesso!');
